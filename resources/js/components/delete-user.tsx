...
export default function DeleteUser() {
    ...
    return (
        <div className="space-y-6">
            <HeadingSmall title="Apagar conta" description="Apague sua conta e todos os seus recursos" />
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            ...
                            para confirmar que você gostaria de apagar sua conta permanentemente.
                        </DialogDescription>
